...
int main () {
	...
	const int DAY  = 24*60*60;	// NEED TO FIX THIS.  HOW MANY SECONDS IN A DAY?
	const int YEAR = 365*DAY;	// NEED TO FIX THIS.  HOW MANY SECONDS IN A YEAR?
	...
	short seconds = (short) ( 31 * YEAR + 2 * DAY);
	...
	int seconds2 = (int) ( 68 * YEAR + 2 * DAY );

	year  = seconds2 / YEAR;
	day   = ( seconds2 % YEAR ) / DAY;
	cout << endl << "Seconds to January 2, 2038: " << seconds << endl;
